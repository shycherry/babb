...
exports.FrontendView = Backbone.View.extend({
  ...
  initialize : function(){        
    ...
    this.platformsCollectionView = new PlatformsCollectionView( {el : $(BABB.PlatformsConfig.platformsContainerId) } )    
  ...
  initBindings : function(){
    ...
    this.platformsCollectionView.on('selectionChanged', function(iPlatform){
      if(iPlatform){
    ...
    this.platformsCollectionView.on('selectionValidated', function(iPlatform){
      ...
      if(iPlatform != self.currentValidatedPlatform){
        self.unbindRomsCollection()
        self.bindRomsCollection(iPlatform)      
  ...
  bindRomsCollection : function(iPlatform){
    var self = this    
    this.romsCollectionView.doSniff(
      iPlatform.getRomsPaths(),
      iPlatform.getRomsProvider()
    )
